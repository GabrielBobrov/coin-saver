...
INSERT INTO TRANSACTION(AMOUNT, CREATED_AT, DESCRIPTION,  PAY_DAY, STATUS, CATEGORY,TRANSACTION_TYPE, FIXED_EXPENSE, REPEAT, CLIENT_ID) VALUES (150, CURRENT_TIMESTAMP(), 'DESCRIPTION', CURRENT_TIMESTAMP() , 2, 1, 0, 1, null, 1);
